...
/**
 * Run the given program in a child process with exec() and tracing enabled.
 */
...
/**
 * Display memory contents in the inclusive range [from_addr:to_addr] 
 * from the given process's address space.
 */
